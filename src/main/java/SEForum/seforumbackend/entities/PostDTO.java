...
public class PostDTO {
    ...
    public boolean equals(Object o) {
        ...
        return user == postDTO.user && creationTime.equals(postDTO.creationTime) && title.equals(postDTO.title) && content.equals(postDTO.content) && Arrays.equals(comments, postDTO.comments) && Arrays.equals(likes, postDTO.likes) && Arrays.equals(dislikes, postDTO.dislikes) && Objects.equals(optional, postDTO.optional);
    }
